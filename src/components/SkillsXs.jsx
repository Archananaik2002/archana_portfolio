  ...
  return (
    ...
    >
        ...
        <ul className='p-2 shadow-xl rounded-xl'>
            ...
            <li className='hover:bg-[white] hover:text-black border border-white duration-700  m-1 p-1  bg-black text-white rounded'>JAVA</li>
            <li className='hover:bg-[white] hover:text-black border border-white duration-700  m-1 p-1  bg-black text-white rounded'>SQL</li>
            <li className='hover:bg-[white] hover:text-black border border-white duration-700  m-1 p-1  bg-black text-white rounded'>C</li>
            <li className='hover:bg-[white] hover:text-black border border-white duration-700  m-1 p-1  bg-black text-white rounded'>PYTHON</li>
            ...
            <li className='hover:bg-[white] hover:text-black border border-white duration-700  m-1 p-1  bg-black text-white rounded'>PHP</li>
        </ul>
